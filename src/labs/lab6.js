...
class Lab6 extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            stepMove: 0.6,
    ...
    async componentDidMount() {
        ...
        //ADD LIGHT
        this.ambientLight = new THREE.AmbientLight('rgb(0,0,139)')
        this.scene.add(this.ambientLight);

        this.pointLight = new THREE.PointLight('rgb(240,248,255)', 2, 120, 2);
        this.pointLight.castShadow = true;
        this.pointLight.position.set(-30,10,0);
        ...
        this.obj1 = new THREE.Mesh(
            ...
            new THREE.MeshLambertMaterial({color: 'rgb(0, 145, 36)', wireframe: this.state.wireframe})
        )
        ...
        const material2 = new THREE.MeshLambertMaterial({ color: 'red', wireframe: this.state.wireframe})
        ...
        const material3 = new THREE.MeshLambertMaterial({ color: 'rgb(56, 168, 0)', wireframe: this.state.wireframe})
        ...
        const material4 = new THREE.MeshLambertMaterial({ color: 'rgb(128,128,128)', wireframe: this.state.wireframe})
        ...
        this.obj5 = new THREE.Mesh(
            ...
            new THREE.MeshLambertMaterial({color: 'rgb(0, 87, 145)', wireframe: this.state.wireframe})
        )
        ...
        const material5 = new THREE.MeshLambertMaterial({ 
            color: 'rgb(255,255,0)', wireframe: this.state.wireframe})
    ...
    return(
        ...
        <Row>
            ...
            <div>
                ...
                <p className="sceneTitle">Лабораторна робота № 6:   
                    Створення мікропрограми для розрахунку
                    освітлення за методом Ламберта для спрямованого джерела світла</p>
